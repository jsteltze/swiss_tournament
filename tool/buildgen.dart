...
Builder appBuildTimestampGenerator(BuilderOptions options) =>
    AppBuildTimestampGeneratorBuilder();
...
class AppBuildTimestampGeneratorBuilder implements Builder {
  ...
  Future<void> build(BuildStep _) async {
    final outputFile = File('lib/generated/app_build_timestamp.g.dart');
